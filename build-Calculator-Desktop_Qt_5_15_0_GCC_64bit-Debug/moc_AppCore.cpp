...
QT_MOC_LITERAL(1, 11, 14), // "signalSendBack"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "result"
QT_MOC_LITERAL(4, 34, 18), // "slotOperateMessage"
QT_MOC_LITERAL(5, 53, 4), // "num1"
QT_MOC_LITERAL(6, 58, 6), // "symbol"
QT_MOC_LITERAL(7, 65, 4) // "num2"

    },
    "AppHandler\0signalSendBack\0\0result\0"
    "slotOperateMessage\0num1\0symbol\0num2"
};
...
void AppHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSendBack((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->slotOperateMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AppHandler::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppHandler::signalSendBack)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AppHandler::signalSendBack(float _t1)
{
